...
if (!defined("PJ_SCRIPT_VERSION")) define("PJ_SCRIPT_VERSION", "3.4");
if (!defined("PJ_SCRIPT_ID")) define("PJ_SCRIPT_ID", "52");
if (!defined("PJ_SCRIPT_BUILD")) define("PJ_SCRIPT_BUILD", "3.4.2");
if (!defined("PJ_SCRIPT_PREFIX")) define("PJ_SCRIPT_PREFIX", "ts_booking_");
...
$CONFIG = array();
$CONFIG['plugins'] = array('pjLocale', 'pjBackup', 'pjLog', 'pjInstaller', 'pjOneAdmin', 'pjAuthorize', 'pjPaypal', 'pjSms', 'pjCountry', 'pjInvoice');
?>