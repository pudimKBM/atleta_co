...
<div class="leftmenu-middle">
	<ul class="menu">
		...
		{
			?>
			<li><a href="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdminCalendars&amp;action=pjActionIndex" class="<?php echo $_GET['controller'] == 'pjAdminCalendars' ? 'menu-focus' : NULL; ?>"><span class="menu-calendars">&nbsp;</span><?php __('menuCalendars'); ?></a></li>
			<?php
		} 
		?>
		<li><a href="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdminBookings&amp;action=pjActionSchedule" class="<?php echo ($_GET['controller'] == 'pjAdminBookings' || ($_GET['controller'] == 'pjInvoice' && ($_GET['action'] == 'pjActionUpdate' || $_GET['action'] == 'pjActionInvoices' || $_GET['action'] == 'pjActionCreateInvoice') ) ) ? 'menu-focus' : NULL; ?>"><span class="menu-bookings">&nbsp;</span><?php __('menuBookings'); ?></a></li>
		<?php
		if ($controller->isAdmin())
		{
			?>
			...
			<li><a href="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdminOptions&amp;action=pjActionIndex&amp;tab=1" class="<?php echo ($_GET['controller'] == 'pjAdminOptions' && in_array($_GET['action'], array('pjActionIndex'))) || (in_array($_GET['controller'], array('pjAdminLocales', 'pjBackup', 'pjLocale', 'pjSms', 'pjCountry')) || ($_GET['controller'] == 'pjInvoice') && ($_GET['action'] == 'pjActionIndex')) ? 'menu-focus' : NULL; ?>"><span class="menu-options">&nbsp;</span><?php __('menuOptions'); ?></a></li>
