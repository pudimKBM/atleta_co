...
<form action="" method="post" class="pj-form form">
	...
	<div class="b10 p">
		...
		<span class="pj-form-field-custom pj-form-field-custom-after float_left r5">
			<input type="text" name="date" class="pj-form-field w80 datepick pointer required" readonly="readonly" rel="<?php echo $week_start; ?>" rev="<?php echo $jqDateFormat; ?>" value="<?php echo (isset($_GET['booking_date']) && !empty($_GET['booking_date'])) ? $_GET['booking_date'] : date($tpl['option_arr']['o_date_format']); ?>" />
